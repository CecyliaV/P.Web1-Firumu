<%-- 
    Document   : SignIn
    Created on : Nov 26, 2020, 7:01:07 PM
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-yellow nav-link">
        ...
        <!--Apartado para el drop Down-->
          ...
          <a href="EditPerfil.jsp" class="btn btn-primary " role="button">Editar Perfil</a>
          <a href="CreateNotice.jsp" class="btn btn-primary " role="button">Crear Noticia</a>
         <a href="Favorites.jsp" class="btn btn-primary " role="button">Seccion de Favoritos</a>
          <!--<button type="button" class="btn btn-primary" href="Favorites.jsp" class="btn btn-primary ">
